...
candidate_database = {
    "Lane": ["Lane", "0x6253CD18Bd3940178e85af9D66a790Aad87D5Eaa", "4.3", .20, "Images/lane.jpeg"],
...
if st.sidebar.button("Send Transaction"):
    ...
    transaction_hash = send_transaction(w3, account, candidate_address, wages)
